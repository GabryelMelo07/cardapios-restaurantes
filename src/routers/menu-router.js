...
MenuRouter.post('/menus/restaurant/:restaurantId/category/:categoryId/add-product', isAuth, isUserOwnerOrPartnerMiddleware, upload.single('file'), logInfo, (req, res, next) => menuController.addProductToCategory(req, res, next));
...
MenuRouter.put('/menus/restaurant/:restaurantId/product/:productId/update', isAuth, isUserOwnerOrPartnerMiddleware, upload.single('file'), logInfo, (req, res, next) => menuController.updateProduct(req, res, next));
MenuRouter.patch('/menus/restaurant/:restaurantId/product/:productId/upload-image', isAuth, isUserOwnerOrPartnerMiddleware, upload.single('file'), logInfo, (req, res, next) => menuController.uploadProductImage(req, res, next));
